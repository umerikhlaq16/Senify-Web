...
import { Heart, UserPlus, Hand, MessageSquarePlus, Clock, User, Edit2, Trash2 } from 'lucide-react';
    ...
    <div className="h-[400px] w-[400px] bg-[#EEEAFB] pt-12">
      <div className="">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
          ...
          {/* Add New Card */}
          <div 
            className="bg-gray-50 rounded-3xl p-6 text-black flex flex-col w-[450px] h-[400px]"
          >
          ...
          {activeTab === 'requests' && requests.map((request) => (
            <div key={request.id} className="bg-white rounded-3xl p-6 shadow-sm hover:shadow-xl transition-all border border-gray-100 w-[300px] h-[400px] flex flex-col">
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-3">
                  <div className="bg-linear-to-br from-rose-400 to-orange-500 rounded-full w-12 h-12 flex items-center justify-center text-white font-bold text-lg">
              ...
              <button className="w-full bg-linear-to-r from-rose-500 to-orange-500 text-white py-3 rounded-2xl font-semibold hover:shadow-lg transition-all">
                Offer Help
              </button>
            </div>
          ))}
